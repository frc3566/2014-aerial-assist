...
public class RobotMap {
    ...
    public static DigitalInput catapultDogboxEngageLimit;
	...
	LiveWindow.addSensor("Catapult", "Catapult Ready Limit", catapultCatapultReadyLimit);
        ...
        catapultDogboxEngageLimit = new DigitalInput(1, 3);
	LiveWindow.addSensor("Catapult", "Dogbox Engage Limit", catapultDogboxEngageLimit);
