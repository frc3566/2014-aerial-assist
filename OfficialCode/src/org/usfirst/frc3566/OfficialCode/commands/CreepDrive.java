...
/**
 * Convert from full speed to a "creep" (slower) drive.
 */
public class CreepDrive extends Command {
    ...
    protected void execute() {
        Robot.driveTrain.joystickDrive(Robot.oi, RobotConstants.DRIVETRAIN_CREEP_SPEED, RobotConstants.DRIVETRAIN_CREEP_TURN);
    }
