...
public class RobotMap {
    ...
    public static DigitalInput shootingSystemWindowMotorLimit;
    public static SpeedController shootingSystemMotor;
	...
	LiveWindow.addSensor("El_Toro", "LowerCap", el_ToroLowerCap);
        ...
        shootingSystemWindowMotorLimit = new DigitalInput(1, 13);
	LiveWindow.addSensor("ShootingSystem", "WindowMotorLimit", shootingSystemWindowMotorLimit);
        
        shootingSystemMotor = new Talon(1, 8);
	LiveWindow.addActuator("ShootingSystem", "Motor", (Talon) shootingSystemMotor);
