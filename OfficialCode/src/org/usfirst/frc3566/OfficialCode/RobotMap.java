...
public class RobotMap {
    ...
    public static SpeedController catapultDogboxEngageMotor;
    public static SpeedController catapultWinchMotor;
    public static Encoder catapultDogboxEngageEncoder;
    public static DigitalInput catapultCatapultReady;
    public static DigitalInput catapultClutchLimit;
    public static SpeedController flipperUpdownMotor;
    public static DigitalInput flipperUpperCap;
    public static DigitalInput flipperLowerCap;
	...
	LiveWindow.addActuator("Catapult", "Dogbox Engage Motor", (Talon) catapultDogboxEngageMotor);
        
        catapultWinchMotor = new Talon(1, 8);
	LiveWindow.addActuator("Catapult", "Winch Motor", (Talon) catapultWinchMotor);
        
        catapultDogboxEngageEncoder = new Encoder(1, 3, 1, 4, false, EncodingType.k4X);
	LiveWindow.addSensor("Catapult", "Dogbox Engage Encoder", catapultDogboxEngageEncoder);
        catapultDogboxEngageEncoder.setDistancePerPulse(1.0);
        catapultDogboxEngageEncoder.setPIDSourceParameter(PIDSourceParameter.kRate);
        catapultDogboxEngageEncoder.start();
        catapultCatapultReady = new DigitalInput(1, 14);
	LiveWindow.addSensor("Catapult", "CatapultReady", catapultCatapultReady);
        
        catapultClutchLimit = new DigitalInput(1, 13);
	LiveWindow.addSensor("Catapult", "ClutchLimit", catapultClutchLimit);
        
        flipperUpdownMotor = new Talon(1, 7);
	LiveWindow.addActuator("Flipper", "UpdownMotor", (Talon) flipperUpdownMotor);
        
        flipperUpperCap = new DigitalInput(1, 10);
	LiveWindow.addSensor("Flipper", "UpperCap", flipperUpperCap);
        
        flipperLowerCap = new DigitalInput(1, 9);
	LiveWindow.addSensor("Flipper", "LowerCap", flipperLowerCap);
