...
public class El_Toro extends Subsystem {
    ...
    SpeedController elevator = RobotMap.el_ToroElevator;
    DigitalInput upperLimit = RobotMap.el_ToroUpperLimit;
    DigitalInput lowerLimit = RobotMap.el_ToroLowerLimit;
    ...
    public void lower() {
        if (!atLowerLimit()) {
            elevator.set(RobotConstants.EL_TORO_LOWER_SPEED);
        }
    }
