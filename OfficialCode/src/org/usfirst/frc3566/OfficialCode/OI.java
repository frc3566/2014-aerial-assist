...
public class OI {
   ...
   */
    ...
    public JoystickButton StartisResetAutonomous;
    public JoystickButton BackisStopElToro;
    ...
    public OI() {
        ...
        */
        ...
        //On Xbox: A is 1, B is 2, X is 3, Y is 
        AisShoot= new JoystickButton(xBoxDriver,2);
        AisShoot.whenPressed(new FireCatapult());
        YisPrepareCatapult= new JoystickButton(xBoxDriver,4);
        YisPrepareCatapult.whenPressed(new PrepareCatapult());
        XisSpinToVomit= new JoystickButton(xBoxDriver,1);
        XisSpinToVomit.whenPressed(new TwirlElToroInward());
        BisSpinToPickup= new JoystickButton(xBoxDriver,3);
        ...
        StartisResetAutonomous= new JoystickButton(xBoxDriver,10);
        StartisResetAutonomous.whenPressed(new ResetAutonomous());
        BackisStopElToro= new JoystickButton(xBoxDriver,9);
        BackisStopElToro.whenPressed(new StopTwirlingElToro());
        RightAnalogDownisCreep= new JoystickButton(xBoxDriver,12);
        ...
        SmartDashboard.putData("Load Ball", new LoadBall());
