...
public class OI {
   ...
   */
    ...
    public JoystickButton LeftAnalogDownisCreep;
    ...
    public OI() {
        ...
        */
        ...
        StartisResetAutonomous= new JoystickButton(xBoxDriver,8);
        StartisResetAutonomous.whenPressed(new ResetAutonomous());
        BackisStopElToro= new JoystickButton(xBoxDriver,7);
        BackisStopElToro.whenPressed(new StopTwirlingElToro());
        LeftAnalogDownisCreep= new JoystickButton(xBoxDriver,9);
        LeftAnalogDownisCreep.whileHeld(new CreepDrive());
