...
public class OI {
    ...
    public JoystickButton rBPickUpBall;
    ...
    public OI() {
        ...
        thumbCreepDrive = new JoystickButton(rightJoy, 2);
        thumbCreepDrive.whileHeld(new CreepDrive());
        triggerFire = new JoystickButton(rightJoy, 1);
        triggerFire.whenReleased(new FireCatapult());

        bTwirlBallOut = new JoystickButton(xBoxController, 1);
        bTwirlBallOut.whileHeld(new TwirlElToroInward());
        xTwirlBallIn = new JoystickButton(xBoxController, 2);
        xTwirlBallIn.whenPressed(new TwirlElToroOutward());
        backResetAutonomous = new JoystickButton(xBoxController, 10);
        backResetAutonomous.whileHeld(new ResetAutonomous());
        lBVomitBall = new JoystickButton(xBoxController, 5);
        lBVomitBall.whileHeld(new VomitBall());
        rBPickUpBall = new JoystickButton(xBoxController, 6);
        rBPickUpBall.whileHeld(new PickUpBall());
