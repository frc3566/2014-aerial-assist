...
public class OI {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        SmartDashboard.putData("LF Encoder", RobotMap.driveTrainLeftFrontEncoder);
        SmartDashboard.putData("Ultrasonic", RobotMap.driveTrainUltrasonic);
        SmartDashboard.putData("El Toro Lower Limit", RobotMap.el_ToroLowerCap);
        SmartDashboard.putData("El Toro Upper Limit", RobotMap.el_ToroUpperCap);
        SmartDashboard.putData("Catapult Limit", RobotMap.catapultCatapultLimit);
        SmartDashboard.putData("Winch Engage Limit", RobotMap.catapultWinchEngageLimit);
    }
