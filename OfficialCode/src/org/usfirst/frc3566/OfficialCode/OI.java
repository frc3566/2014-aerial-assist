...
public class OI {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        SmartDashboard.putData("El Toro Lower Limit", RobotMap.el_ToroLowerLimit);
        SmartDashboard.putData("El Toro Upper Limit", RobotMap.el_ToroUpperLimit);
        SmartDashboard.putData("Catapult Ready Limit", RobotMap.catapultCatapultReadyLimit);
        SmartDashboard.putData("Dogbox Engage Limit", RobotMap.catapultDogboxEngageLimit);
    }
